...
def upgrade():
    ...
    sa.Column('hap_number', sa.String(length=255), nullable=True),
    sa.Column('hap_name', sa.String(length=255), nullable=True),
    sa.Column('epa_evidence_weight', sa.String(length=255), nullable=True),
