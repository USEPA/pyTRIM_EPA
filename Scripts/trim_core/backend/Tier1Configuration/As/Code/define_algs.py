...
mfp=r"C:\Users\13963\OneDrive - ICF\Documents\RTR\PyTRIM\HSP_Repo\trim-builder\Scripts\trim_core\backend\Tier1Configuration\As\input_files"   # path to met file
...
class diffusion_from_surface_soil_to_air_organics_alginstid_3995:
	def __init__(self, constants,containingscenario,currentchemical,sendingcompartment, receivingcompartment,dict_inputs):
		self.name='diffusion from surface soil to air, organics(alginstid_3995)'
		self.constants=constants
		self.containingscenario=containingscenario
		self.currentchemical=currentchemical
		self.sendingcompartment=sendingcompartment
...
class exchange_from_surface_water_to_fish_cd:
	def __init__(self, constants,containingscenario,currentchemical,sendingcompartment, receivingcompartment,dict_inputs):
		self.name='exchange from surface water to fish, cd'
		self.constants=constants
		self.containingscenario=containingscenario
		self.currentchemical=currentchemical
		self.sendingcompartment=sendingcompartment
...
class exchange_from_surface_water_to_fish_pb:
	def __init__(self, constants,containingscenario,currentchemical,sendingcompartment, receivingcompartment,dict_inputs):
		self.name='exchange from surface water to fish, pb'
		self.constants=constants
		self.containingscenario=containingscenario
		self.currentchemical=currentchemical
		self.sendingcompartment=sendingcompartment
		self.receivingcompartment=receivingcompartment
		self.category='bioenergetic fish model'
		self.chemicalcategory='metals | lead'
		self.doestransformchemical='False'
		self.transportchemical='True'
		self.enabled='True'
		self.isdefaultforcategory='True'
...
class exchange_from_surface_water_to_zooplankton_cd_alginstid_cdabs_z:
	def __init__(self, constants,containingscenario,currentchemical,sendingcompartment, receivingcompartment,dict_inputs):
		self.name='exchange from surface water to zooplankton, cd (alginstid_cdabs_z)'
		self.constants=constants
		self.containingscenario=containingscenario
		self.currentchemical=currentchemical
		self.sendingcompartment=sendingcompartment
...
class exchange_from_surface_water_to_zooplankton_pb:
	def __init__(self, constants,containingscenario,currentchemical,sendingcompartment, receivingcompartment,dict_inputs):
		self.name='exchange from surface water to zooplankton, pb'
		self.constants=constants
		self.containingscenario=containingscenario
		self.currentchemical=currentchemical
		self.sendingcompartment=sendingcompartment
...
class time_dependent_partition_from_benthic_invertebrate_to_bulk_sediment_for_dioxins_icfid_08_003:
	def __init__(self, constants,containingscenario,currentchemical,sendingcompartment, receivingcompartment,dict_inputs):
		self.name='time-dependent partition from benthic invertebrate to bulk sediment for dioxins(icfid_08-003)'
		self.constants=constants
		self.containingscenario=containingscenario
		self.currentchemical=currentchemical
		self.sendingcompartment=sendingcompartment
...
class time_dependent_partition_from_bulk_sediment_to_benthic_invertebrate_for_dioxins_icfid_08_002:
	def __init__(self, constants,containingscenario,currentchemical,sendingcompartment, receivingcompartment,dict_inputs):
		self.name='time-dependent partition from bulk sediment to benthic invertebrate for dioxins(icfid_08-002)'
		self.constants=constants
		self.containingscenario=containingscenario
		self.currentchemical=currentchemical
		self.sendingcompartment=sendingcompartment
...
class time_dependent_partition_from_macrophyte_to_surface_water_alginstid_1544_cd:
	def __init__(self, constants,containingscenario,currentchemical,sendingcompartment, receivingcompartment,dict_inputs):
		self.name='time-dependent partition from macrophyte to surface water(alginstid_1544),cd'
		self.constants=constants
		self.containingscenario=containingscenario
		self.currentchemical=currentchemical
		self.sendingcompartment=sendingcompartment
...
class time_dependent_partition_from_surface_water_to_macrophyte_cd_alginstid_1549:
	def __init__(self, constants,containingscenario,currentchemical,sendingcompartment, receivingcompartment,dict_inputs):
		self.name='time-dependent partition from surface water to macrophyte, cd(alginstid_1549)'
		self.constants=constants
		self.containingscenario=containingscenario
		self.currentchemical=currentchemical
		self.sendingcompartment=sendingcompartment
