...
#add pseudo source dep rates to pseudo compartments
	...
	try:
		...
		pass
	try:
		wetparticlesource_in_wetparticlesource_n7.deposition_rate['chem_arsenic']=2e-11*wetparticlesource_in_wetparticlesource_n7.parcel_area
	except:
		pass
	try:
	...
	try:
		...
		pass
	try:
		wetparticlesource_in_wetparticlesource_n7.deposition_rate['chem_methylmercury']=2e-11*wetparticlesource_in_wetparticlesource_n7.parcel_area
	except:
		pass
	try:
