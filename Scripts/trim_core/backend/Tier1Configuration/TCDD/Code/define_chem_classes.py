...
class chem_2_3_7_8_tcdd:
	...
	@property
	def k_oc(self):
		return (10**((log(self.k_ow)/log(10))-0.21))
	...
	_referencebird_eliminationrate=0.0
	@property
	...
	_referencebird_generaldegradationrate=0.0018
	@property
	...
	_referencemammal_bodyweight=0.021
	@property
	...
	_referencemammal_eliminationrate=0.12
	@property
	...
	_referencemammal_generaldegradationrate=0.41
	@property
...
chem_objects_dict={}
chem_2_3_7_8_tcdd=chem_2_3_7_8_tcdd(constants,containingscenario)
chem_objects_dict["chem_2_3_7_8_tcdd"]=chem_2_3_7_8_tcdd
