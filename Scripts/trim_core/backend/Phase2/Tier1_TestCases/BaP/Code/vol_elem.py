...
class volume_element:
	def __init__(self,ve_name,parcel_name,primary_abiotic,bottom,top,point_ids,area):
...
''')
    ...
    return(df_points,df_parcels,df_ve)
    
    
if __name__ == '__main__':
    df_points,df_parcels,df_ve=define_volume_elements(inputs)