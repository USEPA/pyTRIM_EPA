...
class air:
	...
	def fractionmass_vapor(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=1 -self.chemical_fractionmass_sorbed
		except:
			cdict["chem_arsenic"]=nan
	...
	def airschmidtnumber(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.dynamicairviscosity_m2_per_sec/self.currentchemical.d_pureair_m2_s
		except:
			cdict["chem_arsenic"]=nan
	...
	def particlevolumetricdrydepositionrate(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.chemical_vdep * (self.dustload / self.dustdensity)
		except:
			cdict["chem_arsenic"]=nan
	...
	def particlevolumetricwetdepositionrate(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.chemical_washoutratio * self.containingscenario.rain * (self.dustload / self.dustdensity)
		except:
			cdict["chem_arsenic"]=nan
	...
	def dustresuspensionrate(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.chemical_particlevolumetricdrydepositionrate
		except:
			cdict["chem_arsenic"]=nan
...
class benthic_carnivore:
	...
	def eliminationrateconstant(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=10**(-0.25*log10(self.bw)-2.7)
		except:
			cdict["chem_arsenic"]=nan
...
class groundwater:
	...
	def z_liquid(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.currentchemical.z_purewater
		except:
			cdict["chem_arsenic"]=nan
	...
	def fractionmass_vapor(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.volume * self.volumefraction_vapor * 1000 * (self.chemical_z_vapor /self.chemical_z_liquid) / self.chemical_genericdenominatorforcalculatingfractioninphases
		except:
			cdict["chem_arsenic"]=nan
	...
	def genericdenominatorforcalculatingfractioninphases(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.volume * ( (self.chemical_kd * self.rho) * (1 - self.volumefraction_liquid - self.volumefraction_vapor) + self.volumefraction_liquid * 1000 + self.volumefraction_vapor * (self.chemical_z_vapor /self.chemical_z_liquid) * 1000 )
		except:
			cdict["chem_arsenic"]=nan
	...
	def fractionmass_dissolved(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.volume * self.volumefraction_liquid * 1000 /self.chemical_genericdenominatorforcalculatingfractioninphases
		except:
			cdict["chem_arsenic"]=nan
	...
	def kd(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=10**(-2.87671+0.495043*self.ph -0.00500349*self.fractionsand*100+0.55245*log10(self.organiccarboncontent*1000000))
		except:
			cdict["chem_arsenic"]=nan
	...
	def z_total(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.chemical_z_solid * (1 - self.porosity) + self.chemical_z_liquid* self.volumefraction_liquid + self.chemical_z_vapor * self.volumefraction_vapor
		except:
			cdict["chem_arsenic"]=nan
	...
	def z_solid(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=(self.rho * self.chemical_kd / 1000) * self.currentchemical.z_purewater
		except:
			cdict["chem_arsenic"]=nan
	...
	def fractionmass_sorbed(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.volume * (self.chemical_kd * self.rho) * (1 - self.volumefraction_liquid - self.volumefraction_vapor ) / self.chemical_genericdenominatorforcalculatingfractioninphases
		except:
			cdict["chem_arsenic"]=nan
	...
	def z_vapor(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.currentchemical.z_pureair
		except:
			cdict["chem_arsenic"]=nan
...
class sediment:
	...
	def genericdenominatorforcalculatingfractioninphases(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.volume * self.volumefraction_solid * self.chemical_kd * self.rho * self.constants.m3_per_l + self.volume * self.volumefraction_liquid
		except:
			cdict["chem_arsenic"]=nan
	...
	def boundarylayerthicknessbelowwater(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=318 * self.chemical_d_effective ** (0.683)
		except:
			cdict["chem_arsenic"]=nan
	...
	def z_total(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.chemical_z_liquid * self.porosity + self.chemical_z_solid * (1 - self.porosity)
		except:
			cdict["chem_arsenic"]=nan
	...
	def z_solid(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.chemical_kd * (self.rho / 1000) * self.currentchemical.z_purewater
		except:
			cdict["chem_arsenic"]=nan
	...
	def d_effective(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.porosity ** (4 / 3) * self.currentchemical.d_purewater
		except:
			cdict["chem_arsenic"]=nan
	...
	def fractionmass_sorbed(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.volume * self.volumefraction_solid * self.chemical_kd * self.rho * self.constants.m3_per_l  /self.chemical_genericdenominatorforcalculatingfractioninphases
		except:
			cdict["chem_arsenic"]=nan
...
class soil_root_zone:
	...
	def dx2(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=2*self.depth*sqrt(self.constants.pi) if (self.chemical_effectiveadvectionvelocity==0) else min(4 * self.chemical_d_effective /self.chemical_effectiveadvectionvelocity,2*self.depth*sqrt(self.constants.pi))
		except:
			cdict["chem_arsenic"]=nan
	...
	def concentrationoutputfactor(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=1000 / (self.rho * self.chemical_volumefraction_solid)
		except:
			cdict["chem_arsenic"]=nan
	...
	def depth_times_z_total(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.height * self.chemical_z_total
		except:
			cdict["chem_arsenic"]=nan
	...
	def gradientofsoilconcentrationchange(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.chemical_gradientofsoilconcentrationchange_calculated if (self.chemical_useinputcharacteristicdepth_0_meansno_elseyes!=0) else 1/self.chemical_inputcharacteristicdepth_m
		except:
			cdict["chem_arsenic"]=nan
	...
	def d_times_gamma(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.chemical_gradientofsoilconcentrationchange * self.chemical_d_effective
		except:
			cdict["chem_arsenic"]=nan
	...
	def genericdenominatorforcalculatingfractioninphases(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.volume * ((self.chemical_kd * self.rho) * (1 - self.chemical_volumefraction_liquid - self.volumefraction_vapor) + self.chemical_volumefraction_liquid * 1000 + self.volumefraction_vapor * (self.chemical_z_vapor /self.chemical_z_liquid) * 1000 )
		except:
			cdict["chem_arsenic"]=nan
	...
	def fractionmass_dissolved(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.volume * self.chemical_volumefraction_liquid * 1000 /self.chemical_genericdenominatorforcalculatingfractioninphases
		except:
			cdict["chem_arsenic"]=nan
	...
	def z_total(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.chemical_z_solid * (1 - self.chemical_porosity) + self.chemical_z_liquid* self.chemical_volumefraction_liquid + self.chemical_z_vapor * self.volumefraction_vapor
		except:
			cdict["chem_arsenic"]=nan
	...
	def z_times_d_times_gamma(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.chemical_z_total * self.chemical_d_times_gamma
		except:
			cdict["chem_arsenic"]=nan
	...
	def one_minus_exp_neg_depth_times_gamma(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=1 - self.chemical_exp_neg_depth_times_gamma
		except:
			cdict["chem_arsenic"]=nan
	...
	def depth_times_gamma(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.chemical_gradientofsoilconcentrationchange * self.height
		except:
			cdict["chem_arsenic"]=nan
	...
	def gradientofsoilconcentrationchange_calculated(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=1/self.chemical_dx2 if (self.chemical_totaltransformationrate == 0) else 1/min(self.chemical_dx1, self.chemical_dx2)
		except:
			cdict["chem_arsenic"]=nan
	...
	def d_effective(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.currentchemical.z_purewater /self.chemical_z_total * self.currentchemical.d_purewater * self.chemical_volumefraction_liquid ** (10 / 3) / self.chemical_porosity ** 2 + self.currentchemical.z_pureair /self.chemical_z_total * self.currentchemical.d_pureair * self.volumefraction_vapor ** (10 / 3) / self.chemical_porosity ** 2
		except:
			cdict["chem_arsenic"]=nan
	...
	def porosity(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.chemical_volumefraction_liquid + self.volumefraction_vapor
		except:
			cdict["chem_arsenic"]=nan
	...
	def volumefraction_solid(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=1.0 - self.chemical_porosity
		except:
			cdict["chem_arsenic"]=nan
	...
	def effectiveadvectionvelocity(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.averageverticalvelocity * self.currentchemical.z_purewater/self.chemical_z_total
		except:
			cdict["chem_arsenic"]=nan
	...
	def fractionmass_sorbed(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.volume * (self.chemical_kd * self.rho) * (1 - self.chemical_volumefraction_liquid - self.volumefraction_vapor) / self.chemical_genericdenominatorforcalculatingfractioninphases
		except:
			cdict["chem_arsenic"]=nan
	...
	def dx1(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=(self.chemical_effectiveadvectionvelocity/ (2*self.chemical_totaltransformationrate)) +sqrt((self.chemical_effectiveadvectionvelocity / (2*self.chemical_totaltransformationrate))**2 + self.chemical_d_effective / self.chemical_totaltransformationrate) if self.chemical_effectiveadvectionvelocity>0 else sqrt(self.chemical_d_effective / self.chemical_totaltransformationrate)
		except:
			cdict["chem_arsenic"]=nan
	...
	def exp_neg_depth_times_gamma(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=exp(-self.chemical_depth_times_gamma)
		except:
			cdict["chem_arsenic"]=nan
...
class soil_surface:
	...
	def wetconcoutputfactor(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=(self.chemical_volumefraction_solid * self.rho) / ((self.chemical_volumefraction_solid * self.rho) + (self.chemical_volumefraction_liquid * self.constants.kg_per_m3_water))
		except:
			cdict["chem_arsenic"]=nan
...
class soil_vadose_zone:
	...
	def d_effective(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.currentchemical.z_purewater /self.chemical_z_total * self.currentchemical.d_purewater * self.volumefraction_liquid ** (10 / 3) / self.porosity ** 2 + self.currentchemical.z_pureair /self.chemical_z_total * self.currentchemical.d_pureair * self.volumefraction_vapor ** (10 / 3) / self.porosity ** 2
		except:
			cdict["chem_arsenic"]=nan
...
class surface_water:
	...
	def fractionmass_algae(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.volume * (self.volumefraction_algae) * self.chemical_ratioofconcinalgaetoconcdissolvedinwater * self.algaedensity_g_m3 * (self.constants.m3_per_l) / self.chemical_genericdenominatorforcalculatingfractioninphases
		except:
			cdict["chem_arsenic"]=nan
	...
	def z_algae(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=(self.chemical_ratioofconcinalgaetoconcdissolvedinwater*self.algaedensity_g_m3/1000.0)*self.currentchemical.z_purewater
		except:
			cdict["chem_arsenic"]=nan
	...
	def fractionmass_dissolved(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.volume * (self.volumefraction_liquid) / self.chemical_genericdenominatorforcalculatingfractioninphases
		except:
			cdict["chem_arsenic"]=nan
	...
	def z_total(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.chemical_z_liquid *self.volumefraction_liquid +self.chemical_z_solid *self.volumefraction_solid + self.chemical_z_algae*self.volumefraction_algae
		except:
			cdict["chem_arsenic"]=nan
	...
	def genericdenominatorforcalculatingfractioninphases(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.volume * (self.volumefraction_algae * self.chemical_ratioofconcinalgaetoconcdissolvedinwater * self.algaedensity_g_m3 * (self.constants.m3_per_l)  + self.volumefraction_solid * self.chemical_kd * self.constants.m3_per_l * self.rho + self.volumefraction_liquid )
		except:
			cdict["chem_arsenic"]=nan
	...
	def waterschmidtnumber(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.waterviscosity/(self.waterdensity * self.currentchemical.d_purewater_m2_per_s)
		except:
			cdict["chem_arsenic"]=nan
	...
	def d_effective(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.currentchemical.d_purewater
		except:
			cdict["chem_arsenic"]=nan
	...
	def fractionmass_sorbed(self):
		cdict={}
		try:
			cdict["chem_arsenic"]=self.volume * (self.volumefraction_solid) * self.chemical_kd * self.constants.m3_per_l * self.rho / self.chemical_genericdenominatorforcalculatingfractioninphases
		except:
			cdict["chem_arsenic"]=nan
