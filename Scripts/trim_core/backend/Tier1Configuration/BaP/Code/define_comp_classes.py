...
class air:
	...
	def particlevolumetricwetdepositionrate(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.chemical_washoutratio * self.containingscenario.rain * (self.dustload / self.dustdensity)
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def generaldegradationrate(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=log(2)/ self.chemical_halflife
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def washoutratio(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=200000.0
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def initialconcentration_g_per_m3(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.containingscenario.fractioninitialconcentrations * self.chemical_initialconcentration_g_per_m3_usersupplied
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def dustresuspensionrate(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.chemical_particlevolumetricdrydepositionrate
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def z_total(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.chemical_z_solid * (self.dustload /self.dustdensity) +self.chemical_z_vapor * (1 - (self.dustload /self.dustdensity))
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def halflife(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=0.046
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def z_liquid(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.currentchemical.z_purewater
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def particlegaspartitioncoefficient(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=10** ( self.currentchemical.log10_k_oa  + log(self.fractionorganicmatteronparticulates+1.0e-10)/log(10) - 11.91)
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def z_solid(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.chemical_z_vapor * (self.chemical_fractionmass_sorbed/self.volumetricairparticlecontent)/(self.chemical_fractionmass_vapor/self.volumetricairaircontent)
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def fractionmass_sorbed(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=1 - 1/(1+self.chemical_particlegaspartitioncoefficient * self.dustload* self.constants.ug_per_kg)
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def fractionmass_vapor(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=1 -self.chemical_fractionmass_sorbed
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def particlevolumetricdrydepositionrate(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.chemical_vdep * (self.dustload / self.dustdensity)
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def airschmidtnumber(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.dynamicairviscosity_m2_per_sec/self.currentchemical.d_pureair_m2_s
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def z_vapor(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.currentchemical.z_pureair
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def vdep(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=500.0
		except:
			cdict["chem_benzo_a_pyrene"]=nan
...
class benthic_carnivore:
	...
	def fishchemicaluptakerateviagill(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=1000 * (((self.bw * 1000) ** (-self.chemical_gamma_fish)) / self.fishlipidfraction) * self.chemical_chemicaltransferefficiencyinfish
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def gilleliminationrate(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.chemical_fishchemicaluptakerateviagill / self.currentchemical.k_ow
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def halflife(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=1.925
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def assimilationefficiencyfromfood(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=0.15
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def initialconcentration_g_per_kg(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.containingscenario.fractioninitialconcentrations * self.chemical_initialconcentration_g_per_kg_usersupplied
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def chemicaltransferefficiencyinfish(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=(10 ** (-1.5 + 0.4 * self.currentchemical.log10_k_ow) if ( self.currentchemical.log10_k_ow < 3) else (0.5 if (self.currentchemical.log10_k_ow >= 3) and (self.currentchemical.log10_k_ow < 6) else (10 ** (1.2 - 0.25 * self.currentchemical.log10_k_ow)) ) ) if self.bw > 0.1 else (10 ** (-2.6 + 0.5 * self.currentchemical.log10_k_ow) if (self.currentchemical.log10_k_ow < 5) else (0.8 if (self.currentchemical.log10_k_ow >= 5) and (self.currentchemical.log10_k_ow < 6) else (10 ** (2.9 - 0.5 * self.currentchemical.log10_k_ow) )))
		except:
			cdict["chem_benzo_a_pyrene"]=nan
...
class benthic_invertebrate:
	...
	def clearanceconstant(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=100.6
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def uptakeconstant(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.chemical_clearanceconstant
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def sedimentpartitioning_alphaofequilibrium(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=0.95
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def halflife(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=16.5
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def sedimentpartitioning_timetoreachalphaofequilibrium(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=14.0
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def v_d(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=7235.0
		except:
			cdict["chem_benzo_a_pyrene"]=nan
...
class groundwater:
	...
	def totaltransformationrate(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.chemical_generaldegradationrate
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def genericdenominatorforcalculatingfractioninphases(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.volume * ( (self.chemical_kd * self.rho) * (1 - self.volumefraction_liquid - self.volumefraction_vapor) + self.volumefraction_liquid * 1000 + self.volumefraction_vapor * (self.chemical_z_vapor /self.chemical_z_liquid) * 1000 )
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def d_effective(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.currentchemical.z_purewater /self.chemical_z_total * self.currentchemical.d_purewater * self.volumefraction_liquid ** (10 / 3) / self.porosity ** 2 + self.currentchemical.z_pureair /self.chemical_z_total * self.currentchemical.d_pureair * self.volumefraction_vapor ** (10 / 3) / self.porosity ** 2
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def z_total(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.chemical_z_solid * (1 - self.porosity) + self.chemical_z_liquid* self.volumefraction_liquid + self.chemical_z_vapor * self.volumefraction_vapor
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def halflife(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=1060.0
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def z_solid(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=(self.rho * self.chemical_kd / 1000) * self.currentchemical.z_purewater
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def fractionmass_sorbed(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.volume * (self.chemical_kd * self.rho) * (1 - self.volumefraction_liquid - self.volumefraction_vapor ) / self.chemical_genericdenominatorforcalculatingfractioninphases
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def fractionmass_vapor(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.volume * self.volumefraction_vapor * 1000 * (self.chemical_z_vapor /self.chemical_z_liquid) / self.chemical_genericdenominatorforcalculatingfractioninphases
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def fractionmass_dissolved(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.volume * self.volumefraction_liquid * 1000 /self.chemical_genericdenominatorforcalculatingfractioninphases
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def kd(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.currentchemical.k_oc * self.organiccarboncontent
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def initialconcentration_g_per_l(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.containingscenario.fractioninitialconcentrations * self.chemical_initialconcentration_g_per_l_usersupplied
		except:
			cdict["chem_benzo_a_pyrene"]=nan
...
class leaf_coniferous_forest_in_coniferous_forest:
	...
	def totalcuticularconductance(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=1/(1.0/self.chemical_cuticularconductance  + 1.0/self.chemical_boundarylayerconductance)
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def totalstomatalconductance(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=1.0 / ((1.0 / self.chemical_stomataconductance) + (1.0 / self.chemical_boundarylayerconductance))
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def z_total(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=0.18* self.currentchemical.z_pureair + 0.8*self.currentchemical.z_purewater + 0.02*self.currentchemical.k_ow*self.currentchemical.z_purewater
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def boundarylayerconductance(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.currentchemical.d_pureair/self.thicknessofboundarylayerthicknessthroughstillair
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def transferfactortoleafparticle(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=1.0e-4
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def stomataconductance(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.currentchemical.d_pureair * self.stomatalareanormalizedeffectivediffusionpathlength * self.degreestomatalopening
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def air_z_total(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.currentchemical.z_pureair * (1 - self.dustload / self.dustdensity) * (1+self.chemical_particlegaspartitioncoefficient * self.dustload * self.constants.ug_per_kg)
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def cuticularconductance(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=86400 * 10 ** (0.704 * self.currentchemical.log10_k_ow - 11.2) / (self.chemical_air_z_total / self.currentchemical.z_purewater)
		except:
			cdict["chem_benzo_a_pyrene"]=nan
...
class leaf_particle_coniferous_forest_in_coniferous_forest:
	...
	def halflife(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=2.31
		except:
			cdict["chem_benzo_a_pyrene"]=nan
...
class macrophyte:
	...
	def depurationrate(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=1 / (1.58 + 0.000015 * self.currentchemical.k_ow)
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def bioaccumulationrate(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=1 / (0.002 + 500 /self.currentchemical.k_ow)
		except:
			cdict["chem_benzo_a_pyrene"]=nan
...
class root_grasses_herbs_in_grasses_herbs:
	...
	def halflife(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=34.6
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def rootsoilwaterinteraction_t_alpha(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=2*(1.62 + exp(self.currentchemical.log10_k_ow - 1.8)) / 24
		except:
			cdict["chem_benzo_a_pyrene"]=nan
...
class sediment:
	...
	def genericdenominatorforcalculatingfractioninphases(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.volume * self.volumefraction_solid * self.chemical_kd * self.rho * self.constants.m3_per_l + self.volume * self.volumefraction_liquid
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def d_effective(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.porosity ** (4 / 3) * self.currentchemical.d_purewater
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def z_total(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.chemical_z_liquid * self.porosity + self.chemical_z_solid * (1 - self.porosity)
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def halflife(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=2290.0
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def z_solid(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.chemical_kd * (self.rho / 1000) * self.currentchemical.z_purewater
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def fractionmass_sorbed(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.volume * self.volumefraction_solid * self.chemical_kd * self.rho * self.constants.m3_per_l  /self.chemical_genericdenominatorforcalculatingfractioninphases
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def boundarylayerthicknessbelowwater(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=318 * self.chemical_d_effective ** (0.683)
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def fractionmass_dissolved(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.volume * self.volumefraction_liquid /self.chemical_genericdenominatorforcalculatingfractioninphases
		except:
			cdict["chem_benzo_a_pyrene"]=nan
...
class soil_root_zone:
	...
	def concentrationoutputfactor(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=1000 / (self.rho * self.chemical_volumefraction_solid)
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def z_times_d_times_gamma(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.chemical_z_total * self.chemical_d_times_gamma
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def gradientofsoilconcentrationchange(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.chemical_gradientofsoilconcentrationchange_calculated if (self.chemical_useinputcharacteristicdepth_0_meansno_elseyes!=0) else 1/self.chemical_inputcharacteristicdepth_m
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def dx2(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=2*self.depth*sqrt(self.constants.pi) if (self.chemical_effectiveadvectionvelocity==0) else min(4 * self.chemical_d_effective /self.chemical_effectiveadvectionvelocity,2*self.depth*sqrt(self.constants.pi))
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def exp_neg_depth_times_gamma(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=exp(-self.chemical_depth_times_gamma)
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def depth_times_gamma(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.chemical_gradientofsoilconcentrationchange * self.height
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def genericdenominatorforcalculatingfractioninphases(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.volume * ((self.chemical_kd * self.rho) * (1 - self.chemical_volumefraction_liquid - self.volumefraction_vapor) + self.chemical_volumefraction_liquid * 1000 + self.volumefraction_vapor * (self.chemical_z_vapor /self.chemical_z_liquid) * 1000 )
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def d_effective(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.currentchemical.z_purewater /self.chemical_z_total * self.currentchemical.d_purewater * self.chemical_volumefraction_liquid ** (10 / 3) / self.chemical_porosity ** 2 + self.currentchemical.z_pureair /self.chemical_z_total * self.currentchemical.d_pureair * self.volumefraction_vapor ** (10 / 3) / self.chemical_porosity ** 2
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def z_total(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.chemical_z_solid * (1 - self.chemical_porosity) + self.chemical_z_liquid* self.chemical_volumefraction_liquid + self.chemical_z_vapor * self.volumefraction_vapor
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def halflife(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=530.0
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def volumefraction_solid(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=1.0 - self.chemical_porosity
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def one_minus_exp_neg_depth_times_gamma(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=1 - self.chemical_exp_neg_depth_times_gamma
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def fractionmass_sorbed(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.volume * (self.chemical_kd * self.rho) * (1 - self.chemical_volumefraction_liquid - self.volumefraction_vapor) / self.chemical_genericdenominatorforcalculatingfractioninphases
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def porosity(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.chemical_volumefraction_liquid + self.volumefraction_vapor
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def dx1(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=(self.chemical_effectiveadvectionvelocity/ (2*self.chemical_totaltransformationrate)) +sqrt((self.chemical_effectiveadvectionvelocity / (2*self.chemical_totaltransformationrate))**2 + self.chemical_d_effective / self.chemical_totaltransformationrate) if self.chemical_effectiveadvectionvelocity>0 else sqrt(self.chemical_d_effective / self.chemical_totaltransformationrate)
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def d_times_gamma(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.chemical_gradientofsoilconcentrationchange * self.chemical_d_effective
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def inputcharacteristicdepth_m(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=0.08
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def gradientofsoilconcentrationchange_calculated(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=1/self.chemical_dx2 if (self.chemical_totaltransformationrate == 0) else 1/min(self.chemical_dx1, self.chemical_dx2)
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def fractionmass_dissolved(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.volume * self.chemical_volumefraction_liquid * 1000 /self.chemical_genericdenominatorforcalculatingfractioninphases
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def depth_times_z_total(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.height * self.chemical_z_total
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def effectiveadvectionvelocity(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.averageverticalvelocity * self.currentchemical.z_purewater/self.chemical_z_total
		except:
			cdict["chem_benzo_a_pyrene"]=nan
...
class soil_surface:
	...
	def vapordrydepositionvelocity_m_day(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.currentchemical.d_pureair / self.airsoilboundarythickness
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def masstransfercoefficientonairsideofairsoilboundary(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.chemical_vapordrydepositionvelocity_m_day
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def wetconcoutputfactor(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=(self.chemical_volumefraction_solid * self.rho) / ((self.chemical_volumefraction_solid * self.rho) + (self.chemical_volumefraction_liquid * self.constants.kg_per_m3_water))
		except:
			cdict["chem_benzo_a_pyrene"]=nan
...
class stem_grasses_herbs_in_grasses_herbs:
	...
	def tscf(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=0.7 * exp(-((self.currentchemical.log10_k_ow - 3.07) ** 2) / 2.78)
		except:
			cdict["chem_benzo_a_pyrene"]=nan
...
class surface_water:
	...
	def z_total(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.chemical_z_liquid *self.volumefraction_liquid +self.chemical_z_solid *self.volumefraction_solid + self.chemical_z_algae*self.volumefraction_algae
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def ratioofconcinalgaetoconcdissolvedinwater(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=510.0
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def d_effective(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.currentchemical.d_purewater
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def halflife(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=0.138
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def fractionmass_sorbed(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.volume * (self.volumefraction_solid) * self.chemical_kd * self.constants.m3_per_l * self.rho / self.chemical_genericdenominatorforcalculatingfractioninphases
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def waterschmidtnumber(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.waterviscosity/(self.waterdensity * self.currentchemical.d_purewater_m2_per_s)
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def fractionmass_algae(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.volume * (self.volumefraction_algae) * self.chemical_ratioofconcinalgaetoconcdissolvedinwater * self.algaedensity_g_m3 * (self.constants.m3_per_l) / self.chemical_genericdenominatorforcalculatingfractioninphases
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def z_algae(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=(self.chemical_ratioofconcinalgaetoconcdissolvedinwater*self.algaedensity_g_m3/1000.0)*self.currentchemical.z_purewater
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def genericdenominatorforcalculatingfractioninphases(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=self.volume * (self.volumefraction_algae * self.chemical_ratioofconcinalgaetoconcdissolvedinwater * self.algaedensity_g_m3 * (self.constants.m3_per_l)  + self.volumefraction_solid * self.chemical_kd * self.constants.m3_per_l * self.rho + self.volumefraction_liquid )
		except:
			cdict["chem_benzo_a_pyrene"]=nan
...
class zooplankton:
	...
	def assimilationefficiencyfromalgae(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=0.25
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def absorptionrateconstant(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=42652.78
		except:
			cdict["chem_benzo_a_pyrene"]=nan
	...
	def eliminationrateconstant(self):
		cdict={}
		try:
			cdict["chem_benzo_a_pyrene"]=1.3864
		except:
			cdict["chem_benzo_a_pyrene"]=nan
